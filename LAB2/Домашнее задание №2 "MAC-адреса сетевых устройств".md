...
МАС-адрес коммутатора S1 Fast Ethernet 0/1: 0001.640a.ce0e
...
В таблице МАС-адресов видим только MAC-адрес коммутатора S2 который сосоставлен с портом Fa0/1
